...
const Profile = () => {
    ...
    const [editShop, setEditShop] = useState(userInfo.shopInfo ? false : true);
                ...
                <div className='w-full md:w-6/12'>
                    <div className='w-full p-4 bg-[#6a5fdf] rounded-md text-[#d0d2d6]'>
                        <div className='flex justify-center items-center py-3'>
                            {userInfo?.image
                                ? <label htmlFor="img" className='h-[150px] w-[150px] relative p-3 cursor-pointer overflow-hidden'>
                                    <img src={userInfo.image} className='w-full h-full object-contain' alt="" />
                        ...
                        <div className='px-0 md:px-5 py-2'>
                            {userInfo.shopInfo && (
                                <div className='mb-3 flex justify-between text-sm flex-col gap-2 p-4 bg-slate-800 rounded-md relative'>
                                    <span className='p-[6px] bg-yellow-500 rounded hover:shadow-lg hover:shadow-yellow-500/50 absolute right-2 top-2 cursor-pointer' onClick={() => setEditShop(!editShop)}><FaRegEdit /></span>
                                    <div className='flex gap-2'>
                                        <span>Shop Name: </span>
